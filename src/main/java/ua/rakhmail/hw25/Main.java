...
public class Main {
    public static void main(String[] args) {
        ...
        Vehicle vehicle1 = new Vehicle("Batgirl Cycle", "1950-05-30", 25000, "very sexy type", "2021-01-01", owner1);
        Vehicle vehicle2 = new Vehicle("BlackHand car", "1999-09-29", 12500, "very strong type", "2015-02-02", owner2);
        Vehicle vehicle3 = new Vehicle("New Flash Cycle", "1988-08-08", 5000, "very fast type", "2018-08-08");
        vehicle3.setOwner(owner3);
        Vehicle vehicle4 = new Vehicle("Flash Cycle", "1940-07-07", 10000, "very cool type", "2014-04-04", owner4);
        Vehicle vehicle5 = new Vehicle("Joker Bicycle", "1966-06-06", 1, "very funny type", "2019-12-31");
