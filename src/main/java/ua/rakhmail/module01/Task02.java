...
public class Task02 {
    ...
    private final String secondCoordinate;
        ...
        public static void main(String[] args) {
            Task02 chessHorse = new Task02();
            System.out.println(chessHorse.moveHorse(chessHorse.firstCoordinate, chessHorse.secondCoordinate));
            System.out.println(chessHorse.moveHorse("C5asfd124", "E4asf124"));
            System.out.println(chessHorse.moveHorse("H0", "G2"));
            System.out.println(chessHorse.moveHorse("A1", "H7"));
        }

        public boolean moveHorse(String current, String target) {
